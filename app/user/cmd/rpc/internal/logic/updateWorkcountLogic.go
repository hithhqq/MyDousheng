...
type UpdateWorkcountLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewUpdateWorkcountLogic(ctx context.Context, svcCtx *svc.ServiceContext) *UpdateWorkcountLogic {
	return &UpdateWorkcountLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *UpdateWorkcountLogic) UpdateWorkcount(in *pb.UpdateWorkCountReq) (*pb.UpdateWorkCountResp, error) {
	// todo: add your logic here and delete this line
	fmt.Printf("UpdateWorkcount start..\n")
	...
	fmt.Printf("UpdateWorkcount end..\n")
